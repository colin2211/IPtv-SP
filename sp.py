...
user ="IPtv.notifications@gmail.com"
pwd = "HSRT23.07.2020"
...
#query = {'Where': ['And'('Lt', 'EndDate', str(date.today()) ),('IsNotNull','Person')]}
...
#dpd = pd.concat([data,data1.rename(columns = {"Tasche":"Item"})]).dropna(thresh=1)
#dpd= pd.concat([data,data1.rename(columns = {"Tasche":"Item"})], ignore_index=True, sort=False)
